	...
	class ConnectionMSSQL :Connectionc
	{
		...
		public override List<Tablee> nacitajTabulky()
		{
		   ...
		   foreach (Tablee tab in vystup)
			{
				nacitajStlpcePreTab(tab);
				nacitajPrivileges(tab);
				nacitajTrigre(tab);
				nacitajConstraintypreTab(tab);
				nacitajIndexyPreTab(tab);
				//nacitajPKPreTab(tab);
				//nacitajFKPreTab(tab);
				nacitajFKPreTabNew(tab);
				nacitajPKPreTabNew(tab);
			}
			return vystup;

		}
		private void nacitajConstraintypreTab(Tablee tab)
		{
			SqlCommand com = pripojenie.CreateCommand();
		...
		private void nacitajPrivileges(Tablee tab)
		{
			SqlCommand com = pripojenie.CreateCommand();
		...
		private void nacitajTrigre(Tablee tab)
		{
			SqlCommand com = pripojenie.CreateCommand();
		...
		private void nacitajIndexyPreTab(Tablee tab)
		{
			SqlCommand com = pripojenie.CreateCommand();
		...
		private void nacitajStlpcePreTab(Tablee tab)
		{
			SqlCommand com = pripojenie.CreateCommand();
		...
		private void nacitajFKPreTabNew(Tablee tab)
		{
